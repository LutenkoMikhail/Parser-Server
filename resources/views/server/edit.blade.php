                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="brand" type="text"
                                                   ...
                                                   name="brand" value="{{ $server->brand }}" maxlength="255" required
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="location" type="text"
                                                   ...
                                                   name="location" value="{{ $server->location}}" maxlength="255"
                                                   required
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="cpu" type="text"
                                                   ...
                                                   name="cpu" value="{{ $server->cpu}}" maxlength="255" required
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="drive" type="text"
                                                   ...
                                                   name="drive" value="{{ $server->drive}}" maxlength="255" required
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="price" type="number"
                                                   ...
                                                   name="price" value="{{ $server->price}}" step="any" min="1" required
                                                   autocomplete="price"
                                                   autofocus>
                                            @error('price')
                                            <span class="invalid-feedback" role="alert">
